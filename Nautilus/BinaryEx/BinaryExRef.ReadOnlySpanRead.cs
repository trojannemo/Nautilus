...
namespace BinaryEx
{
    public static partial class BinaryExRef
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining), TargetedPatchingOptOut("Inline across assemplies")]
        public static float ReadFloatLE(this ReadOnlySpan<byte> buff, ref int offset)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining), TargetedPatchingOptOut("Inline across assemplies")]
        public static float ReadFloatBE(this ReadOnlySpan<byte> buff, ref int offset)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining), TargetedPatchingOptOut("Inline across assemplies")]
        public static double ReadDoubleLE(this ReadOnlySpan<byte> buff, ref int offset)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining), TargetedPatchingOptOut("Inline across assemplies")]
        public static double ReadDoubleBE(this ReadOnlySpan<byte> buff, ref int offset)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining), TargetedPatchingOptOut("Inline across assemplies")]
        public static void ReadBytes(this ReadOnlySpan<byte> buff, ref int offset, Span<byte> output)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining), TargetedPatchingOptOut("Inline across assemplies")]
        public static void ReadCountLE<T>(this ReadOnlySpan<byte> buff, ref int offset, Span<T> output) where T : unmanaged
        {
