...
namespace Nautilus.x360
{
    ...
    public sealed class RSAParams
    {
        ...
        void XLoadCON(DJsIO xKV)
        {
            ...
            // D is a constant
            xK.D = Nautilus.Properties.Resources.XK0;
        ...
        public RSAParams(StrongSigned xTypeIn)
        {
            ...
            switch (xTypeIn)
            {
                case StrongSigned.LIVE:
                    xReader = new DJsIO(Nautilus.Properties.Resources.XK4, true);
                    break;

                case StrongSigned.PIRS:
                    xReader = new DJsIO(Nautilus.Properties.Resources.XK5, true);
                    break;
            ...
            xK.D = Nautilus.Properties.Resources.XK3;
            xReader.Position = 0;
